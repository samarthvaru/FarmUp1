    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.PositiveSmallIntegerField(blank=True, choices=[(1, 'superuser'), (2, 'farmer'), (3, 'customer')], default=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.CharField(blank=True, default='', max_length=20)),
                ('state', models.CharField(blank=True, default='', max_length=20)),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='cust_profile', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
