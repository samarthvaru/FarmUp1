...
class ProductManager(models.Manager):
    ...
    def get_product_for_farmer(self, request,user_username):
        qs = self.get_queryset().filter(
            sold_by_id__user__username=user_username)
...
class Product(models.Model):
    ...
    tag = models.ManyToManyField(
        Tag, blank=True, related_name="tag_list")
    sold_by = models.ForeignKey(Farmer,on_delete=models.CASCADE, related_name="farmer_products")
